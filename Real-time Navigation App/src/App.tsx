...
export default function App() {
  ...
  return (
    <div className="relative h-screen w-full bg-gray-100 overflow-hidden max-w-[480px] mx-auto">
      {isNavigating && selectedRoute ? (
        ...
        <>
          ...
          {selectedRoute && !isNavigating && (
            <div className="absolute bottom-0 left-0 right-0 z-20 bg-white rounded-t-3xl p-6 shadow-2xl">
              <div className="flex items-center justify-between mb-4">
                <div>
                  <h3 className="text-blue-600 mb-1">선택된 경로</h3>
